...
public abstract class BaseDequeTests extends BaseTest {
    ...
    */
    ...
    @Test
    void resize_afterAddFirst_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 9; i++) {
            deque.addFirst(-1);
        }
    ...
    @Test
    void resize_afterAddLast_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 9; i++) {
            deque.addLast(-1);
        }
    ...
    @Test
    void downsize_afterRemoveLast_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 9; i++) {
            deque.addFirst(-1);
        }
    ...
    @Test
    void downsize_afterRemoveFirst_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 9; i++) {
            deque.addFirst(-1);
        }
    ...
    @Test
    void downsize32_afterRemoveLast_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 17; i++) {
            deque.addFirst(-1);
        }
    ...
    // ***************  Start of LinkedDeque Tests
    @Test
    void addMultipleToFront_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 6; i++) {
            deque.addFirst(5);
        }
        assertThat(deque.size()).isEqualTo(6);
        //assertThat(deque.back.value).isEqualTo(5);
        checkInvariants(deque);
    }

    @Test
    void addOneToBack_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        deque.addLast(7);
        assertThat(deque.size()).isEqualTo(1);
        //assertThat(deque.back.value).isEqualTo(5);
    ...
    @Test
    void addMultipleToDequeLast_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 6; i++) {
            deque.addLast(5);
        }
    ...
    @Test
    void removeFirst_afterAddMultipleToBack_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 3; i++) {
            deque.addFirst(i);
        }
    ...
    @Test
    void removeFirst_afterInsertingFirst_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        deque.addFirst(4);
        int val = deque.removeFirst();
    ...
    @Test
    void removeFirst_afterInsertingLast_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        deque.addLast(7);
        int val = deque.removeFirst();
    ...
    @Test
    void removeLast_afterInsertingFirst_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 5; i++) {
            deque.addFirst(i);
        }
    ...
    @Test
    void removeLast_afterInsertingOne_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        deque.addLast(7);
        int val = deque.removeLast();
        assertThat(val).isEqualTo(7);
    ...
    @Test
    void getIndex_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 9; i++) {
            deque.addLast(i);
        }
    ...
    @Test
    void getIndexatEnd_returnsCorrectDeque() {
        Deque<Integer> deque = createDeque();
        for (int i = 0; i < 9; i++) {
            deque.addLast(i);
        }
